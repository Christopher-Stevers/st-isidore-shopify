        ...
        <div className="flex flex-col gap-12 mx-auto max-w-[800px]  text-xl">
          {isSubscribed ? (
            ...
            <div className="px-8 flex flex-col gap-4">
              ...
              <p>
                I{"'"}m Chris Stevers, and I{"'"}d like to deliver my ranch{"'"}
                s 100% grass-fed and grass-finished beef to your door.
              </p>
              <p>
                Ready to get started? Subscribe to our newsletter to get 2 free
                packs of our premium ground beef plus exclusive sales and
          ...
          <div className="flex flex-col gap-6 px-8">
            ...
            <div className="flex flex-col gap-8">
              <p>
                "The beef was excellent. Has more taste than any beef I've tried
                in the last 20 years at least."
