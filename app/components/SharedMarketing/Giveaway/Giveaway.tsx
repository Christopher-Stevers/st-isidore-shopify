    ...
    return (
        <form onSubmit={handleSubmit} className="mt-6 text-black space-y-4">
            ...
            <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-md bg-yellow-500 px-6 py-4 text-lg font-bold text-white transition hover:bg-yellow-600 disabled:opacity-50 disabled:cursor-not-allowed"
            >
                <ZapIcon
                    className="h-4 w-4"
                />
            ...
            <header className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <img
                            src="https://i.imgur.com/rN5nO8E.png" // Using the image from the screenshot
                            alt="Ewing Family Farm Lamb Giveaway"
                    ...
                    <div className="text-center md:text-left">
                        <h1 className="text-4xl font-extrabold text-gray-900 sm:text-5xl">
                            $400 of Free Beef: You Could Win It!
                        </h1>
                        <p className="mt-4 text-lg text-gray-600">
                            Ontario grassfed beef, raised on my small family farm.
                        </p>
                        <GiveawayForm />
                    </div>
                </div>
                    ...
                    <ul className="mt-12 space-y-5">
                        <li className="flex items-start">
                            <p className="ml-3 text-base text-gray-700">
                                🥩 <strong>6 NY Strip Steaks (6–8 oz each).</strong> Classic steakhouse cut — sear hot for a perfect crust.
                            </p>
                        </li>

                        <li className="flex items-start">
                            <p className="ml-3 text-base text-gray-700">
                                🥩 <strong>2 Tenderloin Medallions (3.5–4 oz each).</strong> Buttery-tender special-occasion bites.
                            </p>
                        </li>

                        <li className="flex items-start">
                            <p className="ml-3 text-base text-gray-700">
                                🥩 <strong>2 Petite Shoulder Filets (6 oz each).</strong> Weeknight-friendly — great grilled or pan-seared.
                            </p>
                        </li>

                        <li className="flex items-start">
                            <p className="ml-3 text-base text-gray-700">
                                🥩 <strong>10 Sirloin Tip Steaks (~10–12 oz each).</strong> Lean, flavorful marinating steaks — ideal for grills, fajitas, or stir-fries.
                            </p>
                        </li>

                        <li className="flex items-start">
                            <p className="ml-3 text-base text-gray-700">
                                🥩 <strong>2 Round Steaks (~10–12 oz each).</strong> Versatile — quick skillet sear or braise low and slow for tenderness.
                            </p>
                        </li>

                        <li className="flex items-start">
                            <p className="ml-3 text-base text-gray-700">
                                🍖 <strong>2 Cross Rib Roasts (~5.5 lbs total).</strong> Sunday-style pot roast — set it and forget it in the oven or crockpot.
                            </p>
                        </li>

                        <li className="flex items-start">
                            <p className="ml-3 text-base text-gray-700">
                                🍖 <strong>2 Blade Roasts (~2.5 lbs).</strong> Rich and beefy — perfect for braising with onions and herbs.
                            </p>
                        </li>
                ...
                <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
                        ...
                        <div className="text-center">
                            ...
                            <img
                                src="https://i.imgur.com/Kz8jD0N.png"
                        ...
                        <div className="text-center">
                            {/* TODO: Replace with your image */}
                            <img
                                src="https://i.imgur.com/xT0gqXb.png"
                                alt="Sheep in a barn"
                                className="mx-auto h-56 w-full rounded-lg object-cover shadow-lg"
                            />
                            <h3 className="mt-6 text-2xl font-bold text-gray-900">
                            ...
                            <p className="mt-2 text-gray-600">
                               Your Beef comes directly from our Ontario ranch so you can know for sure it's 100% Canadian grassfed and finished.
                            </p>
                        </div>
                        {/* Feature 3 */}
                        <div className="text-center">
                            {/* TODO: Replace with your image */}
                            <img
                                src="https://i.imgur.com/rN555mO.png"
